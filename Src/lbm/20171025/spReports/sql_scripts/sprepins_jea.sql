Rem
Rem $Header: sprepins.sql 09-aug-2007.20:14:55 cdgreen Exp $
Rem
Rem sprepins.sql
Rem
...
col avwt_fmt format 9999999     heading 'Avg|wait|(ms)';
...
column pt  format   999,999,999,990.9  heading 'per Trans';
...
col waits      format 9,999,999,990 heading 'Buffer|Waits'
...
col bbwait  format 9,999,999,999 heading 'Buffer|Busy|Waits'
...
column elcts  format    999,999,999    heading 'Est LC|Time|Saved|(s)';
...
column elcmoh format  999,999,999,999  heading 'Est LC|Mem|Obj Hits';
...
column edbts    format  99,999,999,990   heading 'Est DB|Time (s)';
column edbtf    format             99.0  heading 'Est DB|Time Factor';
column epr      format  999,999,999,999  heading 'Est Physical|Reads';
...
btitle off;
repfooter off;
set linesize 178 termout on feedback 6;
undefine begin_snap
undefine end_snap
undefine dbid
undefine inst_num
